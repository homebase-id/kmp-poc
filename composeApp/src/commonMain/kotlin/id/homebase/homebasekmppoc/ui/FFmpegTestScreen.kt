...
@Composable
fun FFmpegTestScreen(onBack: () -> Unit) {
        ...
        scope.launch {
            try {
                ...
                if (file != null) {
                    ...
                    // Use platform-agnostic cache helper
                    val path = FFmpegUtils.cacheInputVideo(fileName, bytes)
                    selectedFilePath = path
                    logText = "Selected and Cached: $path"
                }
            } catch (e: Exception) {
    ...
    Column(
        ...
        Text("FFmpeg Test Playground (Unified)", style = MaterialTheme.typography.titleLarge)
        ...
        if (selectedFilePath != null) {
            Text("Input: $selectedFilePath", style = MaterialTheme.typography.bodyMedium)
