...
class DriveMainIndexWrapper(
    ...
    fun upsertDriveMainIndex(
        ...
        fileSystemType: Long,
        jsonHeader: String,
    ): QueryResult<Long> = delegate.upsertDriveMainIndex(identityId, driveId, fileId, uniqueId, globalTransitId, groupId, senderId, fileType, dataType, archivalStatus, historyStatus, userDate, created, modified, fileSystemType, jsonHeader)
    ...
    fun deleteBy(
        ...
        driveId: Uuid,
        fileId: Uuid,
    ): QueryResult<Long> = delegate.deleteBy(identityId, driveId, fileId)
}